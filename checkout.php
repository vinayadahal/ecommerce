...
<div class="container">
    ...
    <div class="shipAddr">
        ...
        <p><?php echo $custRow['firstname']; ?>  <?php echo $custRow['lastname']; ?></p>
        <p><?php echo $custRow['email']; ?></p>
        <p><?php echo $custRow['phone']; ?></p>
        <p><?php echo $custRow['address']; ?></p>
    </div>
    <div class="footBtn">
        <a href="productview.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue Shopping</a>
